...
class TestRun(unittest.TestCase):
    ...
    def test_run_freezing(self):
        ...
        expected_message = "Freezing below %sF: 2?, %.0fF" % (Setup.temp_min, temp)
        self.mon.stop = True
    ...
    def test_process_input(self):
        ...
        self.mon.device.smsGetMessages = Mock(return_value = (0, [{"date" : str(int(last_msg_time.timestamp()/1000)), "address":"123456789", "body": "hi"}], None))
    ...
    def test_execute_command_failed(self):
        ...
        self.mon.log_error.assert_called_once_with('Error execution command No_Setup.temp_max = 78.33. error ("name \'No_Setup\' is not defined",)')
    ...
    def test_execute_command_failed2(self):
        ...
        self.assertNotEquals(78.33, Setup.temp_max)
        self.mon.log_error.assert_called_once_with("Error execution command Regular text message. error ('invalid syntax', ('<string>', 1, 12, 'Regular text message\\n'))")
